...
public class Dinosaur : MonoBehaviour
{
    ...
    private Maybe<Animator> _animatorGetter => Maybe.Just(GetComponent<Animator>());
    ...
    static readonly int k_Hit = Animator.StringToHash(HitParameterName);
    static readonly int k_Attack = Animator.StringToHash(AttackParameterName);
    ...
    private IEnumerator WalkBackSequence() {
        ...
        yield return RotateTowards(parent);
        yield return MoveTowards(parent, 0.1f);
    ...
    private void Awake() {
        _animator = _animatorGetter.Value;
        CurrentState = State.Idle;
    }
}
